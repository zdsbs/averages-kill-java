...
public class HandleWorkOrderCompletedEventsTest {
	...
	private static final class NotifiableWorkOrderCompletedEventSource implements WorkOrderEventSource, WorkOrderCompletedListener {
	...
	/*
	 * NOTE 3/2
	 * I ignore any kinds of events after my timeout except for tick events
